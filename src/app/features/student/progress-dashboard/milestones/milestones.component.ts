    ...
    <div class="p-6 max-w-6xl mx-auto space-y-12 font-sans text-black">
      ...
      >
        <div>
          ...
          <p class="text-gray-600 mt-2 text-lg font-bold">
            Collect badges and celebrate your progress!
          </p>
        </div>
        <div
          class="flex items-center gap-4 bg-[#0ABAB5]/10 p-4 border-4 border-black rounded-2xl"
        >
