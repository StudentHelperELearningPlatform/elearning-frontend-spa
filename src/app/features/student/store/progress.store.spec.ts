...
describe('ProgressStore', () => {
  ...
  it('sets loading true while request is pending', () => {
    ...
    http.expectOne(`${environment.services.auth}/api/v1/students/1/dashboard`).flush(mockDashboard);
  ...
  it('sets error state when API fails', () => {
    store.loadDashboard('1');
    http.expectOne(`${environment.services.auth}/api/v1/students/1/dashboard`).error(new ProgressEvent('error'));
