  ...
  template: `
    <div class="min-h-screen bg-white font-sans text-black overflow-x-hidden">
      ...
      <section class="relative px-6 py-20 md:py-32 flex flex-col items-center text-center overflow-hidden border-b-4 border-black">
        <!-- Background Elements -->
        <div class="absolute top-10 left-10 w-24 h-24 bg-[#0ABAB5]/20 border-4 border-black rounded-full -z-10 animate-bounce"></div>
        <div class="absolute bottom-10 right-10 w-32 h-32 bg-black/5 border-4 border-black rotate-12 -z-10"></div>
        <div class="absolute top-1/2 left-1/4 w-12 h-12 bg-[#0ABAB5] border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] -z-10 animate-pulse"></div>

        <h1 class="text-6xl md:text-8xl font-black uppercase italic tracking-tighter leading-none mb-8">
          Learn <span class="text-[#0ABAB5] underline decoration-black underline-offset-8">Faster</span>.<br>
        ...
        <div class="mt-20 relative group">
          <div class="absolute inset-0 bg-[#0ABAB5] translate-x-4 translate-y-4 -z-10 border-4 border-black rounded-3xl group-hover:translate-x-6 group-hover:translate-y-6 transition-transform"></div>
        ...
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div class="space-y-6 group cursor-pointer" routerLink="/for-students">
              ...
              <h3 class="text-3xl font-black uppercase italic tracking-tight group-hover:text-[#0ABAB5] transition-colors">For Students</h3>
      ...
      <!-- CTA Section -->
      <section class="px-6 py-20 bg-[#0ABAB5] text-white text-center">
