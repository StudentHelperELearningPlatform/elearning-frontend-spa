  ...
  template: `
      ...
      @if (authStore.isAuthenticated()) {
        <div class="flex items-center space-x-6">
            @if (authStore.isAuthenticated()) {
              <div class="flex items-center space-x-6">
                <button class="relative w-12 h-12 rounded-2xl border-2 border-black flex items-center justify-center bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none transition-all outline-none focus:ring-4 focus:ring-[var(--color-primary)]/30">
                ...
                <div 
                  class="flex items-center space-x-4 cursor-pointer group outline-none focus:ring-4 focus:ring-[var(--color-primary)]/30 rounded-xl p-1" 
                  ...
                  <div class="text-right hidden sm:block">
                    <p class="text-base font-bold text-black group-hover:text-[var(--color-primary)] transition-colors">
